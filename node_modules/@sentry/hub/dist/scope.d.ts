...
export declare class Scope {
    ...
    addEventProcessor(callback: (scope: SentryEvent) => Promise<SentryEvent | null>): void;
    /**
     ...
     */
    protected notifyEventProcessors(event: SentryEvent): Promise<SentryEvent | null>;
    /**
     ...
     * @param maxBreadcrumbs number of max breadcrumbs to merged into event.
     */
    applyToEvent(event: SentryEvent, maxBreadcrumbs?: number): Promise<SentryEvent | null>;
}
