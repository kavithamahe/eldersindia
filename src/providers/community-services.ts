...
export class CommunityServices {
  ...
  getCommunityPostsUrl:any;
   constructor(public appConfig:AppConfig,private transfer: Transfer, public http: Http, private filePath: FilePath, public storage:Storage,public toastCtrl: ToastController) {
